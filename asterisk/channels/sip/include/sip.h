 ...
 */
#define DEFAULT_ALLOWED_METHODS "INVITE, ACK, CANCEL, BYE, REFER, NOTIFY"
#define ALLOWED_METHODS (ast_strlen_zero(p->allowed_methods_str) ? DEFAULT_ALLOWED_METHODS : p->allowed_methods_str)
...
#define DEFAULT_USERAGENT  ""  /*!< Default Useragent: header unless re-defined in sip.conf */
#define DEFAULT_SDPSESSION "-"  /*!< Default SDP session name, (s=) header unless re-defined in sip.conf */
#define DEFAULT_SDPOWNER   "-"          /*!< Default SDP username field in (o=) header unless re-defined in sip.conf */
...
#define SIP_EARLYMEDIA_YES		(0 << 0)
#define SIP_EARLYMEDIA_NO		(1 << 0)
#define SIP_EARLYMEDIA_FORCE		(2 << 0)
#define sip_earlymedia_yes(peer)	(peer->earlymedia == SIP_EARLYMEDIA_YES)
#define sip_earlymedia_no(peer)		(peer->earlymedia == SIP_EARLYMEDIA_NO)
#define sip_earlymedia_force(peer)	(peer->earlymedia == SIP_EARLYMEDIA_FORCE)
...
struct sip_pvt {
	...
	int authbye;                        /*!< Send Auth Info on BYE */
	char allowed_methods_str[256];      /*!< Allow: header */
	int setfromname;                    /*!< Set fromname or not */

	int earlymedia;				/*!< Earlymedia type */
	int dontsendcancel;			/*!< Don't send CANCEL in sip_hangup */
